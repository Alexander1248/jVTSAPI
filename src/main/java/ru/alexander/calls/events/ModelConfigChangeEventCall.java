...
public class ModelConfigChangeEventCall implements APICall {
    ...
    public static class Response {
        ...
        @SerializedName("hotkeyConfigChanged")
        private boolean hotkeyConfigChanged;
    }
}
