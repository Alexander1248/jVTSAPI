...
public class VTubeStudioAPI {
    ...
    public void subscribe(
            ...
            ResponseListener<LinkedTreeMap<String, Object>> responseListener,
            EventListener<LinkedTreeMap<String, Object>> eventListener
    ) {
        LinkedTreeMap<String, Object> object = new LinkedTreeMap<>();
    ...
    public void unsubscribe(
            @NotNull String eventName,
            ResponseListener<LinkedTreeMap<String, Object>> listener
    ) {
        LinkedTreeMap<String, Object> object = new LinkedTreeMap<>();
        object.put("eventName", eventName);
    ...
    public void tintArtMeshes(
            ...
            ResponseListener<LinkedTreeMap<String, Object>> response) {
        LinkedTreeMap<String, Object> map = new LinkedTreeMap<>();
        LinkedTreeMap<String, Object> colorTint = new LinkedTreeMap<>();
    ...
    public void loadItem(
            ...
            ResponseListener<LinkedTreeMap<String, Object>> response) {
       LinkedTreeMap<String, Object> map = configureItemLoading(
    ...
    public void loadCustomItem(
            ...
            boolean locked,
            boolean unloadWhenPluginDisconnects,
            ResponseListener<LinkedTreeMap<String, Object>> response) throws IOException {
        LinkedTreeMap<String, Object> map = configureItemLoading(
                fileName, x, y, size, rotation,
                fadeTime, order, failIfOrderTaken,
                smoothing, censored, flipped, locked,
    ...
    private LinkedTreeMap<String, Object> configureItemLoading(@NotNull String fileName, float x, float y, float size, float rotation, float fadeTime, int order, boolean failIfOrderTaken, float smoothing, boolean censored, boolean flipped, boolean locked, boolean unloadWhenPluginDisconnects) {
        LinkedTreeMap<String, Object> map = new LinkedTreeMap<>();
    ...
    public void pinItemToModel(
        ...
        LinkedTreeMap<String, Object> pinInfo = new LinkedTreeMap<>();
